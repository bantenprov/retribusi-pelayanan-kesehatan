          ...
          <div class="card-body">
            <form action="{{route('tarif.store')}}" method="post">
              ...
              <div class="form-group">
								...
								<input type="number" class="form-control" id="jasa_pelayanan" name="jasa_pelayanan">
							</div>

              <div class="form-group">
								<label for="jasa_sarana">Jasa Sarana</label>
								<input type="number" class="form-control" id="jasa_sarana" name="jasa_sarana">
							</div>
              ...
              <div class="form-group">
                ...
                <select id="satuan" name="satuan" class="form-control form-control">
                  ...
                  @foreach (config('pelayanan-kesehatan.satuan') as $key => $satuan)
                    <option value="{{$key}}">{{$satuan}}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <select id="master_tarif_id" name="master_tarif_id" class="form-control form-control">
                  ...
                  @foreach ($master_tarifs as $key => $master_tarif)
                    <option value="{{$master_tarif->id}}">{{$master_tarif->nama}}</option>
                  @endforeach
                </select>
              </div>
